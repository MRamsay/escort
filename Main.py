...
def main():
    ...
    Ships_savedText = scoreFont.render(
        "Ships saved: " + str(game.get_Ships_saved()) + " /" + str(saved_ships_required[difficulty]), True, WHITE)
    ...
    intro_outro_script(surface, background_transparent, background_x, scoreFont,
                       "Save " + str(saved_ships_required[difficulty]) + " of our ships!")
    ...
    while game_over == False:
        ...
        for sprite in critter_sprites:
            sprite.update_position(SPEED, WINDOWWIDTH, WINDOWHEIGHT, game, seconds,
        ...
        for n in range(0, 3):
            if n == 0 and game.get_updated_variables()[n]:
                ...
                Ships_savedText = scoreFont.render(
                    "Ships saved: " + str(game.get_Ships_saved()) + " /" + str(saved_ships_required[difficulty]), True,
                    WHITE)
